...
All fine: no need for `create-new-party.js` here.
...
All fine: no need for `create-by-election.js` here.
...
Then sent to QuickStatements as https://editgroups.toolforge.org/b/QSv2T/1598024899729/
